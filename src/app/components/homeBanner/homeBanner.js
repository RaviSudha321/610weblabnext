            ...
            <div className='container'>
                <div className='home_banner_content'>
                    <div className='banner_left_col'>
                        <h1 className='home_banner_title'>Empowering Your <span>Digital Presence</span> With Expert<span> Web Solutions.</span></h1>
                        <div className='home_banner_desc'>610 WebLab is committed to providing web design & development solutions and delivering results within the demanding time as per the client’s requirements. We believe that our teamwork and relationship with our customers are the backbone of our work.</div>
                        ...
                        <div className='banner_form'>
                            ...
                            <form id="website_audit_form" className='website_audit_form' onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <p className='form_field phone_field'>
                                    ...
                                    <input
                                        type="tel" id="phone" placeholder='Enter Your Phone Number' className={errors.phone? 'has_error':null} {...register("phone",{required: "Phone number is required",minLength: {value: 10,message: "Phone number must be at least 10 digits"},maxLength: {value: 15,message: "Phone number cannot exceed 15 digits"}})}
                                ...
                                <p className='form_field comment_field'>
                                    ...
                                    <textarea id="comment" placeholder='Hi there, I would like to ....' rows="4" className={errors.comment? 'has_error':null} {...register("comment",{required: "Comment is required"})}></textarea>
