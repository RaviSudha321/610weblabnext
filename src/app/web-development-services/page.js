...
function WebDevelopment(){
    ...
    return(
        <div className="web_development_page">
            ...
            imagePosition="left"
            description="Looking to boost your business with a stunning online presence? Hire the best website development agency to achieve your goals. A professional team can design a beautiful, user-friendly website tailored to your needs. With expert guidance, your website will stand out, attracting more customers and enhancing your brand image. Investing in top-notch web development services leads to increased traffic and higher conversions. Let the experts handle the technical details while you focus on growing your business. With a professionally crafted website, you'll make a lasting impression on visitors, driving your success to new heights."
            imageUrl="images/web-dev.webp"
            buttons={
                <Button
                title="Hire An Expert"
